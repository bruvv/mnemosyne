...
|---|---|---|
| `MNEMOSYNE_EMBEDDING_API_URL` | `https://openrouter.ai/api/v1` | Custom embedding API endpoint. When unset, the OpenRouter default is used directly; there is no `OPENROUTER_BASE_URL` fallback. |
